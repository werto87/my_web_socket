...
inline void
test_load_root_certificates (ssl::context &ctx, boost::system::error_code &ec)
{
...
test_load_root_certificates (ssl::context &ctx, boost::system::error_code &ec)
{
  detail::test_load_root_certificates (ctx, ec);
}

inline void
test_load_root_certificates (ssl::context &ctx)
{
